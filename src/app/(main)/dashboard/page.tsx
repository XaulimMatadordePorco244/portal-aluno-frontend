...
export default function DashboardPage() {
  const nomeDoAluno = "Michael Santos";
  const alunoAtual = { rank: 15, nome: "Michael Santos", numero: "2024-015", cargo: "Aluno Soldado" };

  return (
    <div className="container mx-auto py-8">
      <h1 className="text-3xl font-bold text-gray-800 mb-6">
          Mural do Aluno - Bem-vindo, {nomeDoAluno.split(' ')[0]}!
      </h1>
